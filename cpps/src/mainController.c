...
void MainController::invoke_class(JNIEnv *env){
    ...
    jint number=20;
    jint exponent=3;
    hello_world_class = env->FindClass(env, "HelloJNI");
    main_method = env->GetStaticMethodID(env, hello_world_class, "main", "([Ljava/lang/String;)V");
    foi = env->GetStaticMethodID(env, hello_world_class, "foi", "()V");
    ...
    env->CallStaticVoidMethod(env, hello_world_class, foi, NULL);
    /*
